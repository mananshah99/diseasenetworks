...
Description: Determines the quadratic weighted kappa similarity measure between
two datasets (used for the random forest and machine learning classifiers)
'''
